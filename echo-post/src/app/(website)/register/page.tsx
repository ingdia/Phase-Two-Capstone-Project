...
<div className='bg-pink-100 min-h-screen pt-10'>
      ...
      <div className=' shadow-lg shadow-gray-700 py-6 bg-pink-900/90  p-14 flex flex-col md:flex-row gap-4 rounded-md'>
       {/* <h1 className='text-2xl font-bold'>Register</h1> */}
        ...
        <form className='flex flex-col justify-center items-center  bg-gray-200/10 p-10 '  >
          ...
          <input type="password" placeholder='Full name' className='p-2 m-2  text-white  w-70 rounded-full bg-gray-300/20'  required/>
          <input type="password" placeholder='username' className='p-2 m-2  text-white  w-70 rounded-full bg-gray-300/20'  required/>
          <button type='submit' className='bg-white text-amber-950 px-20 p-2 m-2 rounded-full font-bold hover:bg-gray-200' >Register</button>
